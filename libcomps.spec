...
%package staticdev
Summary: staticdev components for the libcomps package.
Group: Default
Requires: libcomps-dev = %{version}-%{release}

%description staticdev
staticdev components for the libcomps package.
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618900070
mkdir -p clr-build
pushd clr-build
